...
They also have a broad range of binding free energies, with available crystal structures and affinities spanning a $\sim$5 kcal/mol range~\cite{Vidler:2013:J.Med.Chem.,Gehling:2013:ACSMed.Chem.Lett.}. 
...
Table ~\ref{polar_benchmark} shows
...
\subsubsection{BRD4 Computational challenge: Flexibility and transition of the ZA-loop}
...
This behavior is not observed for BRD4(1) bound to various ligands in simulations up to 350 ns long, with backbone RMSD values close to 1.00 {\AA} relative to the cocrystal structures~\cite{Su:2017:J.Biomol.Struct.Dyn.} (Heinzelmann et. al, unpublished results). 
...
The results for a given ligand will differ only by an free energy offset depending on this choice. 
...
\subsubsection{BRD4(1) Computational challenge: Possible side-chain rearrangements near the binding site}
