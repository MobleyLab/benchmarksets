...
\midrule
Compound 8a                  & 2295889                                & \parbox[c]{1em}{\includegraphics[scale=0.15]{figures/new-bromo/2295889.pdf}}  & Cc1cc(n2c(n1)ncn2)c3ccccc3                                       & NB$^{\rm d}$                                         & ND$^{\rm c}$                               & ~\cite{Vidler:2013:J.Med.Chem.}         \\ 
Compound 4                   & 975713                                 & \parbox[c]{1em}{\includegraphics[scale=0.15]{figures/new-bromo/975713.pdf}}   & Cc1cc(n2c(n1)nc(n2)N)c3ccccc3                                    & -4.49$^{\rm a,f}$                                    & 4MEQ~\cite{Vidler:2013:J.Med.Chem.}        & ~\cite{Vidler:2013:J.Med.Chem.}         \\ 
...
RVX-OH                       & N/A                                    & \parbox[c]{1em}{\includegraphics[scale=0.15]{figures/new-bromo/RVX-OH.pdf}}   & Cc1cc(cc(c1O)C)c2[nH]c(=O)c3c(n2)cc(cc3OC)OC                     & -8.99\pm0.07$^{\rm b}$                               & 4MR3~\cite{Picaud:2013:PNAS}               & \cite{Picaud:2013:PNAS}                 \\ 
...
Coumpound 3                  & N/A                                    & \parbox[c]{1em}{\includegraphics[scale=0.15]{figures/new-bromo/C-3.pdf}}      & Cc1c(sc-2c1C(=N[C@H](c3c2c(no3)C)CC(=O)N)c4ccc(cc4)Cl)C          & -10.41\pm0.23$^{\rm a}$                              & 4LRG~\cite{Gehling:2013:ACSMed.Chem.Lett.} & \cite{Gehling:2013:ACSMed.Chem.Lett.}   \\ 
\bottomrule
\end{tabular}                                                                                                                                                                                                                                                                                                       \\
\end{center}
