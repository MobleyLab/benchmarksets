...
%DLM: This may be too extensive an overview of prior computational work; we ended up electing (in the other sections) to focus on major issues highlighted by the computational work and NOT to overview individual studies, as there are too many. Come back to this to edit. 
...
This study found an RMSE value of 1.44 kcal/mol and R$^2$ value of 0.43. 
