...
{\bf Manuscript version 1.3.1 pre-release.} See \url{https://github.com/mobleylab/benchmarksets} for all versions.
...
\begin{figure*}
\includegraphics[width=\textwidth]{figures/hosts-CB7-GDCCs-CDs.pdf}
\caption{\label{hosts}
Five host molecules, CB7, OA, TEMOA, $\alpha$-CD, and $\beta$-CD, used in the host-guest benchmark sets.
The CB7 host is a cucurbituril, OA and TEMOA are variants of the octa-acid GDCC, and the two CD hosts are cyclodextrins.
Guest structures are available in subsequent data tables.
The three depictions for each host highlights (from top to bottom) the constituent monomer, the binding site, and a side view.
}
\end{figure*}
...
CDs are cheap to obtain, safe for consumption, and are known to bind a diverse set of ligands, all of which likely accounts for their widespread industrial use, including food applications, cosmetics, pharmaceuticals, and odor suppression.
Indeed, a thorough 1998 review tabulates hundreds of binding data~\cite{rekharsky_complexation_1998}, and many additional measurements have been published since then; e.g. references~\cite{Connors:1997:Chem.Rev., Carrazana:2005:J.Phys.Chem.B, Cotner:1998:J.Org.Chem., Wszelaka-Rylik:2013:JThermAnalCalorim,  Shu:2007:BritishJournalofPharmacology, Rodriguez-Perez:2006:J.Pharm.Sci., Mic:2013:AIPConferenceProceedings}.
...
First, they are more flexible than CB7 or the GDCCs, as their glucose units are joined by only a single bond, which allows greater rotation of each monomer relative to its neighbors. 
...
Together, these features combine to add complexity in predicting the dominant binding poses for guests.
...
The experimental data all originate from the same ITC study \cite{rekharsky_thermodynamic_1997} and experiments were performed under uniform conditions (50 mM sodium phosphate buffer, pH 6.90, 298K). 
...
In addition to the formal benchmark sets listed in Tables~\ref{cd_benchmark1} and \ref{cd_benchmark2}, which only include a representative sample of eight and twelve guests, respectively, we have also made available (in our GitHub repository) an expanded set of guests which differ only slightly from the molecule classes mentioned above, by minor variations in the hydrocarbon substituents.
Despite the flexibility of CD hosts, the small size of the guests combined with long timescale simulations enabled by GPUs appears to allow adequate convergence of these thermodynamic values \cite{henriksen_computational_2015}.
...
\label{cd_benchmark1}
\begin{tabular}{lllp{2cm}>{\ttfamily}lS[table-format=-1.2, table-figures-uncertainty=1]S[table-format=-1.2, table-figures-uncertainty=1]}
\toprule
\multicolumn{1}{c}{ID$^{\rm a}$} & \multicolumn{1}{c}{name} & \multicolumn{1}{c}{PC CID$^{\rm b}$} & \multicolumn{1}{c}{2D} & \multicolumn{1}{c}{\rmfamily SMILES} & \multicolumn{1}{c}{$\Delta G^{\rm c}$ \,{(}kcal/mol{)}} & \multicolumn{1}{c}{$\Delta H^{\rm c}$ \,{(}kcal/mol{)}} \\
\midrule
1    & 1-butylamine             & 8007     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/8007.pdf}}  & CCCCN           & -1.58 \pm 0.02  & -2.17 \pm 0.05 \\
2    & 1-hexylamine             & 8102     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/8102.pdf}}  & CCCCCCN         & -3.53 \pm 0.01  & -4.19 \pm 0.02 \\
3    & 1-octylamine             & 8143     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/8143.pdf}}  & CCCCCCCCN       & -4.61 \pm 0.01  & -5.46 \pm 0.03 \\
4    & cyclopentanol            & 7298     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/7298.pdf}}  &      OC1CCCC1        & -2.13 \pm 0.02  & -2.74 \pm 0.02 \\
5    & cycloheptanol            & 10399    & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/10399.pdf}} &    OC1CCCCCC1      & -2.51 \pm 0.06  & -2.99 \pm 0.23 \\
6    & butanoic acid            & 264      & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/264.pdf}}   & CCCC(=O)O       & -1.51 \pm 0.04  & -2.53 \pm 0.12 \\
7    & hexanoic acid            & 8892     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/8892.pdf}}  & CCCCCC(=O)O     & -3.38 \pm 0.01  & -3.40 \pm 0.02 \\
8    & octanoic acid            & 379      & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/379.pdf}}   & CCCCCCCC(=O)O   & -4.62 \pm 0.02  & -4.89 \pm 0.03 \\
\bottomrule
\end{tabular}\\
$^{\rm a}$ Compound ID assigned in the present work; $^{\rm b}$ PubChem Compound ID; $^{\rm c}$ Standard binding free energy and enthalpy determined by ITC from \cite{rekharsky_thermodynamic_1997}, where all measurements were done in 0.050 mol kg$^{-1}$ (approximately 50 mM) sodium phosphate buffer at pH 6.90 and 298.15 K. At these buffer conditions, the amine guests are expected to be protonated with a formal charge of +1, and the carboxylic acids are expected to be deprotonated with a net charge of $-1$.; Uncertainty is the standard error of the mean in free energy or enthalpy, computed from the reported standard deviations in $K_a$. 
\end{table*}
\endgroup
...
\multicolumn{1}{c}{ID$^{\rm a}$} & \multicolumn{1}{c}{name} & \multicolumn{1}{c}{PC CID$^{\rm b}$} & \multicolumn{1}{c}{2D} & \multicolumn{1}{c}{\rmfamily SMILES} & \multicolumn{1}{c}{$\Delta G^{\rm c}$ \,{(}kcal/mol{)}} & \multicolumn{1}{c}{$\Delta H^{\rm c}$ \,{(}kcal/mol{)}} \\
\midrule
1    & 1-hexylamine                & 8012     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/8102.pdf}}   & CCCCCCN                 & -2.49 \pm 0.08  &  0.60 \pm 0.05 \\
2    & 1-octylamine                & 8143     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/8143.pdf}}   & CCCCCCCCN               & -3.59 \pm 0.12  & -0.48 \pm 0.03 \\
3    & cyclopentanol               & 7298     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/7298.pdf}}   & OC1CCCC1                & -3.05 \pm 0.01  & -1.09 \pm 0.01 \\
4    & trans-4-methylcyclohexanol  & 11524    & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/11524.pdf}}  & C[C@H]1CC[C@H](O)CC1    & -4.54 \pm 0.01  & -2.17 \pm 0.02 \\
5    & cycloheptanol               & 10399    & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/10399.pdf}}  & OC1CCCCCC1              & -4.56 \pm 0.01  & -2.96 \pm 0.01 \\
6    & pentanoic acid              & 7991     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/7991.pdf}}   & CCCCC(=O)O              & -1.27 \pm 0.32  &  1.89 \pm 0.53 \\
7    & heptanoic acid              & 8094     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/8094.pdf}}   & CCCCCCC(=O)O            & -3.39 \pm 0.18  &  0.42 \pm 0.04 \\
8    & benzoic acid                & 243      & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/243.pdf}}    & OC(=O)c1ccccc1         & -1.64 \pm 0.02  & -2.51 \pm 0.08 \\
9    & phenylacetic acid           & 999      & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/999.pdf}}    & OC(=O)Cc1ccccc1        & -1.70 \pm 0.05  & -1.79 \pm 0.11 \\
10   & 4-methylphenylacetic acid   & 248474   & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/248474.pdf}} & Cc1ccc(CC(O)=O)cc1   & -2.19 \pm 0.01  & -2.89 \pm 0.05 \\
11   & 4-methoxyphenylacetic acid  & 7690     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/7690.pdf}}   & COc1ccc(CC(O)=O)cc1    & -2.51 \pm 0.01  & -1.96 \pm 0.01 \\
12   & 4-phenylbutanoic acid       & 4775     & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/4775.pdf}}   & OC(=O)CCCc1ccccc1      & -3.60 \pm 0.02  & -2.82 \pm 0.01 \\
\bottomrule
\end{tabular}\\
$^{\rm a}$ Compound ID assigned in the present work; $^{\rm b}$ PubChem Compound ID; $^{\rm c}$ Standard binding free energy and enthalpy determined by ITC from \cite{rekharsky_thermodynamic_1997}, where all measurements were done in 0.050 mol kg$^{-1}$ (approximately 50 mM) sodium phosphate buffer at pH 6.90 and 298.15 K. At these buffer conditions, the amine guests are expected to be protonated with a formal charge of +1, and the carboxylic acids are expected to be deprotonated with a net charge of $-1$. Uncertainty is the standard error of the mean in free energy or enthalpy, computed from the reported standard deviations in $K_a$. 
\end{table*}
...
Although it is speculated~\cite{rekharsky_thermodynamic_1997, rekharsky_complexation_1998} that polar functional groups will orient towards solvent near the wider rim (also called the secondary face), where they can be better hydrated, and hydrophobic groups will nestle into the hydrophobic cavity of the narrow rim (also called the primary face), there is little data to support this speculation.
Thus it raises the possibility that some guests will prefer one orientation over the other, or possibly a mixture of both. 
Since the cavity is narrow and hydrophobic, interchange between the two orientations is usually slow and requires release into the solvent and subsequent rebinding because the guest is unable to turn around inside the cavity.
Sampling these events could require microsecond-scale simulations or longer, at least for guests which bind with high affinity, since they were not observed to undergo unbinding/binding during microsecond length simulations \cite{henriksen_evaluating_2017}.
...
Force fields for multivalent ions, such as the HPO$_4^{2-}$ species, can be prone to unrealistic aggregation, which itself depends on the particular choice of water model (unpublished, Gilson lab) and may be worth investigating prior to extensive binding calculations. 
Alternatively, one could substitute an equivalent strength of simple, monovalent salt, such as NaCl, for the phosphate buffer on the assumption that this substitution will not affect the binding thermodynamics~\cite{henriksen_evaluating_2017}. }
...
Although experimental literature for CD binding is widely available, not many computational studies include more than just a few guests and, since CDs have not been included in any SAMPL challenges, the unique properties of this host might not be as familiar to many as those of CB7 and OA.
Below, we breifly address prvious studies which offer additional insight on the binding of water and guests to CDs. 
...
%Proposed condensed version -- I tried to hit on the main take-away messages, but feel free to adjust or make your own condensed version.
...
With implicit solvent models, it appears particularly important to supplement the implicit model with a treatment of water sites in the CD cavity; depending on how these sites are handled and the solvent model, RMS errors can be as low as 1.44 kcal/mol (with an $R^2$ of 0.43)~\cite{Wickstrom:2013:J.Chem.TheoryComput.} or as high as 1.9 to 4.8 kcal/mol ($R^2$ of less than 0.3)~\cite{zhang_evaluation_2016}, with these studies examining 57 and 75 guests, respectively.
An extensive explicit solvent study compared a variety of different force fields and water models, with RMS errors of 0.9 to 1.8 kcal/mol ($R^2$ of 0.44 to 0.6) and also examined accuracy of computed binding enthalpies~\cite{henriksen_evaluating_2017}.
...
catechol$^{\rm h}$                 & 289                                  & \parbox[c]{1em}{\includegraphics[scale=0.2]{figures/289.pdf}}      & c1ccc(c(c1)O)O                       & -4.16\pm0.03                                            & 1XEP~\cite{graves_decoys_2005}    & \cite{boyce_predicting_2009}         \\ % relative set we did
