...
Charged ligands are possible~\cite{aldeghi_accurate_2016}, but most are neutral, with many inhibitors having bicyclic and tricyclic ring systems.  
...
Still, it is possible that slower side-chain transitions might still occur on BRD4(1) in the absence of the ligand, which would have to be accounted for if one is looking for gold standard results for this system. 
