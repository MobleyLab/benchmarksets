...
%Get Gilson refs
A number of CD (and other host guest) binding systems are available for download in electronic format at the BindingDB~\cite{Liu:2007:Nucl.AcidsRes.} website (\url{www.bindingdb.org/bind/HostGuest.jsp})
%Add website cite
...
What is new is that the CCP binding sites contain a charged ASP (as evidenced by observed interactions in structures, and by experiments where replacing the ASP with ASN abolishes binding of imidazoles, despite minimal changes to the binding site structure~\cite{Fitzgerald:1995:ProteinScience}). 
