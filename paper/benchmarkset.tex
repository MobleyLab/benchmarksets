...
{\bf Manuscript version 1.2 pre-release.} See \url{https://github.com/mobleylab/benchmarksets} for all versions.
...
Experimental values for cases $^{\rm d}$ and $^{\rm f}$ may not be as high quality as could be desired; however, these cases can still serve very well for method validation when comparison against experiment is a more minor consideration. 
\end{table*}
\endgroup
