...
We extend our protein benchmarks to protein domains called bromodomains, which have recently been the topic of numerous studies in the search for high affinity ligands, using both computational and structure-based techniques. In living cells, bromodomains are responsible for recognizing and binding to acetylated lysine residues present in the histone tails, which are related to epigenetic modifications. They also bind a broad spectrum of small to medium-size molecules with micro and nanomolar affinities, being a promising target for the treatment of conditions such as cancer and inflammation. Bromodomains can be expressed, purified and studied as independent proteins, which greatly facilitates the computational and experimental determination of protein-ligand affintities. There are a total of 61 bromodomains identified in the human proteome, belonging to 46 different proteins. They have about about 110 aminoacids in length and, despite having large sequence variations, all share a common fold, consisting of four anti-parallel $\alpha$-helices folded into a left-handed bundle (Fig. 3A). The helices are connected by two regions known as the ZA and BC-loops, which are part of the acetyl-lysine binding site, displaying different lengths and sequences amongst the various bromodomains. 

In the present benchmark we are going to focus on the first bromodomain of the bromodomain-containing protein 4 (BRD4), belonging to the  BET (bromodomain and extra terminal domain) family, which also includes BRD2, BRD3, and BRDT. The BRD4(1) bromodomain is the most widely studied bromodomain in the BET family, with high-resolution cocrystal structures and/or high-quality experimental affinities available for more than a hundred ligands. Small molecule inhibitors of BRD4(1) show great variety, including distinct groups such as triazole, pyrimidine, acetyl-pyrrole, and isoxazole. Due to the hydrophobic nature of the BRD4(1) binding site, all ligands are neutral, and many of them are also relatively rigid with the presence of single, double and triple rings. This reduces the conformational space of the substrate in the bound and unbound states, providing quicker convergence, and partially avoiding symmetry issues that might appear for ligands with many torsional degrees of freedom. 

In contrast to the T4 lysozyme, all molecules bind to the surface of BRD4(1), making it particularly suitable for free energy calculations that rely on a physical pathway. Additionally, its folded state has shown remarkable stability over $\mu$s scale simulations, which allows for exhaustive (or brute-force) sampling without the risk of irreversible work being performed on the protein structure. These characteristics make the BRD4(1) system a strong candidate for the first protein hard benchmark, but a few important issues have to be addressed in order to make this assertion. They involve the flexibility of the longer ZA-loop in the presence and absence of the substrate, and possible slow side-chain dihedral rotations near the binding site. Below we describe these challenges in more detail, and how they can be overcome. 

\subsubsection{ZA-loop flexibility and side-chain rotations}
