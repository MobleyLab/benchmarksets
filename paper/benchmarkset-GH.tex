...
Bromodomains are protein domains of about 110 amino acids in length, which recognize and bind to acetylated lysine residues present in the histone tails. All bromodomains share a common fold, consisting of four anti-parallel $\alpha$-helices arranged with a left-handed twist (Fig. 3A). Bromodomain-containing proteins (BCPs) have one or more bromodomains, as well as other domains with functions such as chromatin remodeling and the recruitment of other proteins that modify chromatin activity. Human
BCPs have been implicated in a wide range of disorders, including cancer, inflammation, obesity, diabetes, infectious diseases, metabolic disorders and cardiovascular disease. In addition to acetylated lysines, bromodomains are also able to bind small molecules with micro and nanomolar affinities, making them promising targets for the development of new drug leads.

In the present benchmark set we focus on the first bromodomain from the Bromodomain-containing protein 4 (BRD4), which we shall call BD1-BRD4. The latter has been the topic of several experimental and theoretical studies searching for high-affinity inhibitors, and it has high-resolution cocrystal structures and binding affinities for several compounds. BD1-BRD4 is relatively rigid in both the bound and apo states, and all ligands bind to its surface, making it particularly suitable for free energy calculations that rely on a physical pathway. These features make this bromodomain a strong candidate for the first hard benchmark protein system, and we are going to show that there is good consistency between calculated binding free energies using both physical and non-physical (or alchemical) methods. In addition, there is a detailed free energy analysis of the possible conformational changes taking place on this protein domain in the absence of the ligand. This last contribution has to be included when searching for the $absolute$ binding free energies of different ligands, in order to produce rigorous results that are consistent with the force-field of choice. 

\subsubsection{Binding free energy calculations on BD1-BRD4}

Several studies have focused on calculating binding free energies of small molecules to BD1-BRD4, using methods such as alchemical transformations, attach-pull-release, MM-GBSA, MM-PBSA, and simple scoring functions. 
