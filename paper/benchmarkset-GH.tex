...
Bromodomains are protein domains that recognize and bind to acetylated lysine residues present in the histone tails, a known epigenetic marker. They are relatively small, with about 110 aminoacids in length, and share a common fold, consisting of four anti-parallel $\alpha$-helices arranged with a left-handed twist (Fig. 3A). Bromodomain-containing proteins (BCPs) have one or more bromodomains, as well as additional domains responsible for the reading of other markers, chromatin remodeling, and the recruitment of proteins that modify chromatin activity. Human BCPs have been implicated in a wide range of disorders, including cancer, inflammation, obesity, diabetes, infectious diseases, metabolic disorders and cardiovascular disease. In addition to acetylated lysines, bromodomains are also able to bind small molecules with micro and nanomolar affinities, making them promising targets for the design of high-affinity ligands with therapeutic potential.

In the present benchmark set we focus on the first bromodomain from the Bromodomain-containing protein 4 (BRD4), which we will call BRD4(BD1). The latter has been the topic of several experimental and theoretical studies in the search for potent inhibitors, and it has high-resolution cocrystal structures and binding affinities for several compounds. BRD4(BD1) is relatively rigid in both the bound and apo states, and all ligands bind to its surface, making it particularly suitable for free energy calculations that rely on a physical pathway. These features make this bromodomain a strong candidate for the first hard benchmark protein system, with recent studies showing good consistency between calculated binding free energies using both physical and non-physical (or alchemical) methods. In addition, there is a detailed free energy analysis of the possible conformational changes taking place on this protein domain in the absence of the ligand. This last contribution has to be included when searching for the $absolute$ binding free energies of different ligands, in order to produce rigorous results that are consistent with the force-field of choice. 
...
\subsubsection{Dealing with the conformational change of the apo BRD4(BD1)}
